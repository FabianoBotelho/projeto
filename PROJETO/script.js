...
document.getElementById('gym-icon').addEventListener('click', (e) => {
    ...
    addMarkers([
        { address: 'Estr. União e Indústria, 10000 - Itaipava, Petrópolis - RJ', title: 'Parque Municipal de Petrópolis' }, //
        { address: 'Centro, Petrópolis, RJ', title: 'Academia ao Ar Livre no Centro' },
        { address: 'Quitandinha, Petrópolis, RJ', title: 'Academia ao Ar Livre no Quitandinha' }
    ]);
});
...
document.getElementById('danca-icon').addEventListener('click', (e) => {
    e.preventDefault();
    addMarkers([
        { address: 'Mosela, Petrópolis, RJ', title: 'Estúdio de Dança na Mosela' },
        { address: 'Centro, Petrópolis, RJ', title: 'Estúdio de Dança no Centro' },
...
document.getElementById('boxe-icon').addEventListener('click', (e) => {
    e.preventDefault();
    addMarkers([
        { address: 'Valparaíso, Petrópolis, RJ', title: 'Centro de Treinamento de Boxe no Valparaíso' },
        { address: 'Centro, Petrópolis, RJ', title: 'Centro de Treinamento de Boxe no Centro' },
